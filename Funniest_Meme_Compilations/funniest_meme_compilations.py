...
videos_path = current_project_path + '/videos_funniest_meme_compilations/'
html = urllib.request.urlopen("https://www.youtube.com/results?search_query=dank+indian+memes&sp=EgIIAg%253D%253D")
...
TOKEN_NAME = "funniest_meme_compilations_token.json"	# Don't change
...
def uploadYtvid(VIDEO_FILE_NAME='',
		...
		googleAPI.thumbnails().set(
				...
				media_body=MediaFileUpload(current_project_path + "/funniest_meme_compilations_thumbnails/thumbnail_" + str(random.randrange(1, 26)) + ".jpg")
		).execute()
